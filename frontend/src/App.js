          ...
          <div className="main-container">
            <aside className={`sidebar ${sidebarOpen ? 'open' : 'closed'}`}>
              <nav className="nav-menu">
                ...
                <div className="nav-item" onClick={() => window.location.href = '/mesh-vpn'}>
                  🔗 <span>Mesh-VPN</span>
                </div>
              </nav>
            </aside>
            ...
            <main className="content">
              <Routes>
                ...
                <Route path="/mesh-vpn" element={
                  <ProtectedRoute>
                    <div className="mesh-vpn-panel">
                      <h2>🔗 Mesh-VPN Network</h2>
                      <p>Access your dashboard securely via Mesh-VPN mesh network.</p>
