...
# ===== OPTIONAL: Mesh-VPN Setup =====
if command -v docker &> /dev/null; then
    LOG "Mesh-VPN setup (optional):"
    LOG "  1. Install Mesh-VPN: sudo apt install mesh-vpn"
    LOG "  2. Login: sudo mesh-vpn up"
    LOG "  3. Access dashboard via Mesh-VPN IP: http://<mesh-vpn-ip>:3000"
    echo ""
fi
